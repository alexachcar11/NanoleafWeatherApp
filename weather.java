...
public static class Weather { 
	...
	public static Double getTemp() throws Exception { 

		try{ 

			StringBuilder str = new StringBuilder();

			URL url = new URL("https://api.openweathermap.org/data/2.5/weather?q=Montreal&appid=69df68df2814a54fc3200394b7982ddb");
